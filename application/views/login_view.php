...
<a href="index.php" style="color: black;">Welcome! <br/><b>Library System</b></a>
</div>
<div id="tampilalert"></div>
<!-- /.login-logo -->
<div class="login-box-body" style="border:10px solid #1adb51;">
...
<a style="color: white;"> Copyright &copy; Library System <?php echo date("Y");?>
</div>
</footer>
</div>
<!-- /.login-box -->
